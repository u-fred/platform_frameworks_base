...
public class SyntheticPasswordTests extends BaseLockSettingsServiceTests {
    ...
    public void testNoneLskfBasedProtector(boolean primary) throws RemoteException {
        ...
        AuthenticationResult result = manager.unlockLskfBasedProtector(mGateKeeperService,
                protectorId, LockscreenCredential.createNone(), primary ? Primary : Secondary,
                USER_ID, null);
    ...
    public void testNonNoneLskfBasedProtector(boolean primary) throws RemoteException {
        ...
        AuthenticationResult result = manager.unlockLskfBasedProtector(mGateKeeperService,
                protectorId, password, primary ? Primary : Secondary, USER_ID, null);
        assertArrayEquals(result.syntheticPassword.deriveKeyStorePassword(),
                sp.deriveKeyStorePassword());
    ...
    private boolean lskfGatekeeperHandleExists(int userId, boolean primary) throws RemoteException {
        return mGateKeeperService.getSecureUserId(SyntheticPasswordManager.fakeUserId(
                userId, primary ? Primary : Secondary)) != 0;
    }
    ...
    public void testNonEmptyFrpCredentialSyncedIfDeviceNotProvisioned() throws RemoteException {
        ...
        mService.initializeSyntheticPassword(PRIMARY_USER_ID);
        verify(mStorage.mPersistentDataBlockManager, never()).setFrpCredentialHandle(any());
        mService.setLockCredential(newPassword("password"), nonePassword(), Primary, PRIMARY_USER_ID);
        verify(mStorage.mPersistentDataBlockManager).setFrpCredentialHandle(any());
    }
    ...
    public void testChangeCredential() throws RemoteException {
        ...
        mService.setLockCredential(newPassword, password, Primary, PRIMARY_USER_ID);
        assertEquals(VerifyCredentialResponse.RESPONSE_OK, mService.verifyCredential(
                newPassword, Primary, PRIMARY_USER_ID, 0 /* flags */).getResponseCode());
    ...
    public void testVerifyCredential() throws RemoteException {
        ...
        assertEquals(VerifyCredentialResponse.RESPONSE_ERROR, mService.verifyCredential(
                badPassword, Primary, PRIMARY_USER_ID, 0 /* flags */).getResponseCode());
    }
    ...
    public void testClearCredential() throws RemoteException {
        ...
        long sid = mGateKeeperService.getSecureUserId(PRIMARY_USER_ID);
        // clear password
        mService.setLockCredential(nonePassword(), password, Primary, PRIMARY_USER_ID);
        assertEquals(0 ,mGateKeeperService.getSecureUserId(PRIMARY_USER_ID));

        // set a new password
        mService.setLockCredential(badPassword, nonePassword(), Primary, PRIMARY_USER_ID);
        assertEquals(VerifyCredentialResponse.RESPONSE_OK, mService.verifyCredential(
                badPassword, Primary, PRIMARY_USER_ID, 0 /* flags */).getResponseCode());
    ...
    public void testSecondaryUserDoesNotPassAuthSecret() throws RemoteException {
        ...
        assertEquals(VerifyCredentialResponse.RESPONSE_OK, mService.verifyCredential(
                password, Primary, SECONDARY_USER_ID, 0 /* flags */).getResponseCode());
    ...
    public void testTokenBasedResetPassword() throws RemoteException {
        ...
        assertEquals(metric, mService.getUserPasswordMetrics(PRIMARY_USER_ID, Primary));
        // TODO: Primary/secondary.
        verify(mDevicePolicyManager).reportPasswordChanged(metric, PRIMARY_USER_ID, true);

        assertEquals(VerifyCredentialResponse.RESPONSE_OK, mService.verifyCredential(
                pattern, Primary, PRIMARY_USER_ID, 0 /* flags */).getResponseCode());
    ...
    public void testTokenBasedResetPasswordAfterCredentialChanges() throws RemoteException {
        ...
        mService.setLockCredential(pattern, password, Primary, PRIMARY_USER_ID);
    ...
    public void testGetHashFactorManagedProfileUnifiedChallenge() throws RemoteException {
        ...
        mService.setLockCredential(pattern, nonePassword(), Primary, PRIMARY_USER_ID);
    ...
    public void testGetHashFactorManagedProfileSeparateChallenge() throws RemoteException {
        ...
        mService.setLockCredential(primaryPassword, nonePassword(), Primary, PRIMARY_USER_ID);
        mService.setLockCredential(profilePassword, nonePassword(), Primary, MANAGED_PROFILE_USER_ID);
        assertNotNull(
    ...
    public void testPasswordChange_NoOrphanedFilesLeft() throws Exception {
        LockscreenCredential password = newPassword("password");
        initSpAndSetCredential(PRIMARY_USER_ID, password);
        assertTrue(mService.setLockCredential(password, password, Primary, PRIMARY_USER_ID));
    ...
    private void assertNoOrphanedFilesLeft(int userId) {
        ...
        lskfProtectorPrefixes[0] = String.format("%016x",
                mService.getCurrentLskfBasedProtectorId(userId, Primary));
